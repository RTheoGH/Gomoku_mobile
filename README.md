...
Le Gomoku est un jeu de stratégie sur grille où deux joueurs s'affrontent pour aligner cinq pions consécutifs, horizontalement, verticalement ou en diagonale. Il se joue généralement sur un plateau 15x15.

---
## Maquette du projet
La maquette du projet est disponible sur Figma :
[Maquette](https://www.figma.com/design/AxlnxM9Hy4JaJ5YuYxBQoA/Projet-Mobile?node-id=0-1&t=vnK7LLy2JdWbz1tO-1)
...
Ce projet est un projet mobile réalisé sur [Android Studio](https://developer.android.com/studio?hl=fr).

Pour le lancer, il suffit de cloner le projet et d'ouvrir le repertoire App depuis Android Studio.
