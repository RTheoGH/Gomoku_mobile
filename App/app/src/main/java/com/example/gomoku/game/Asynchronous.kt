...
@Composable
fun Asynchronus_create(pad : PaddingValues, navController: NavHostController){
    // TODO : créer une partie en demandant le nom de la partie et mdp
}

@Composable
fun Asynchronus_join(pad : PaddingValues, navController: NavHostController){
    // TODO : rejoindre une partie en demandant le nom de la partie et mdp
}

@Composable
fun Asynchronus_lobby(pad : PaddingValues, navController: NavHostController){
    // TODO : afficher la salle d'attente avec les deux joueurs
}

@Composable
fun Asynchronus_game(pad : PaddingValues, navController: NavHostController){
